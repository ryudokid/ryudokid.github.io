...
let defaultViewMatrix = [
    ...
    //0.1, 6, 1,
    //-0.8842, 0.2595, -0.3841, 0, 0.4535, 0.3795, -0.8018, 0, -0.0602, -0.8934, -0.4535, 0, 0.0896,
    //-0.0912, 0.8095, 1,
    //-0.8842949609470527,0.2595216990033242,-0.38414959298446105,0,
    //0.4534825280467793,0.3795087889246727,-0.8018270860261879,0,
    //-0.06019642129504659,-0.8933661665891314,-0.45351216439811937,0,
    //0.08963071852020503,-0.09119198247021747,0.8094806414403024,1
    //0.47, 0.04, 0.88, 0, -0.11, 0.99, 0.02, 0, -0.88, -0.11, 0.47, 0, 0.07,
    //0.03, 6.55, 1,
    -0.43312941875529704,0.42011162554757464,-0.7954904956619483,0,
    0.8936117802538335,0.25721402349432143,-0.3576296021156651,0,
    0.054352273948529546,-0.876088309571932,-0.4867392568388266,0,
    0.10328891712941272,-0.13884580390489476,1.8043060155724568,1
];
...
async function main() {
    ...
    const url = new URL(
        params.get("url") || "demo.splat",
        "https://huggingface.co/RyudoKID/PV-GAS-Demo/resolve/main/",
    );
    ...
    canvas.addEventListener(
        ...
        (e) => {
            ...
            //document.getElementById("coordinates").innerHTML = "[" + viewMatrix.toString() + "]"; // ZOOM
        },
        { passive: false },
    );
